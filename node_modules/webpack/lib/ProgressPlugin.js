		...
		if(compiler.compilers) {
			...
			compiler.plugin("compilation", function(compilation) {
				...
				const syncHooks = {
					...
					"before-module-assets": [0.89, "module asset processing"],
					"before-chunk-assets": [0.90, "chunk asset processing"],
					"additional-chunk-assets": [0.91, "additional chunk asset processing"],
				...
				compilation.plugin("additional-asset", callback => {
					handler(0.91, "additional asset processing");
					callback();
				});
				compilation.plugin("optimize-chunk-asset", (chunks, callback) => {
					handler(0.92, "chunk asset optimization");
					callback();
				});
				compilation.plugin("optimize-asset", (assets, callback) => {
