...
declare namespace webpack {
    ...
    namespace Options {
        ...
        interface Performance {
            ...
            maxAssetSize?: number;
            /**
             * An entrypoint represents all asset that would be utilized during initial load time for a specific entry.
    ...
    namespace Stats {
        ...
        interface ToJsonOptionsObject {
            ...
            assets?: boolean;
            /** Sort asset by a field */
            assetsSort?: string;
            /** Add information about cached (not built) modules */
            cached?: boolean;
            /** Show cached asset (setting this to `false` only shows emitted files) */
            ...
            /** Exclude asset from being displayed in stats */
